...
const StepSix = (props) => {
  ...
  return (
    <>
      ...
      <StatusCard handleNextStep={handleNextStep} id={docId} titleBook={data.documentStatus.title} publishDate={data.documentStatus.publish} compileState={data.documentStatus.status} image={data.documentStatus.image} />
    </>
  )
}
